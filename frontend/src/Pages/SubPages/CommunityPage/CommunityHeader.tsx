...
const CommunityHeader = ({
  ...
  return (
    <div className="bg-[#13131a] border border-[#2a2a38] rounded-2xl overflow-hidden">
      {/* Banner */}
      <div className="h-24 bg-gradient-to-r from-[#1e1a2e] to-[#2d1f5e]" />
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 className="text-lg font-bold text-[#e0e0f0]">{community.name}</h1>
          ...
          <button
            onClick={onJoinLeave}
            disabled={isJoining}
            className={`flex-shrink-0 px-5 py-2 rounded-xl text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
              isMember
